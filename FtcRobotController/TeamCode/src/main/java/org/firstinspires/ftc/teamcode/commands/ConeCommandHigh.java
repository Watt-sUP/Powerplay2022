 ...
 */
public class ConeCommandHigh extends SequentialCommandGroup {
     ...
     */
    public ConeCommandHigh(@NonNull Cone cone, ColectareSubsystem colectareSystem, TurelaSubsystem turelaSystem, GlisiereSubsystem glisiereSystem) {
        addCommands(
