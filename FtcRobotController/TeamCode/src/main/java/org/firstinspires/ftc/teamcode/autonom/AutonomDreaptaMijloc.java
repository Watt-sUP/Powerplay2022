...
public class AutonomDreaptaMijloc extends CommandOpMode {
    ...
    public static Cone cone1 = new Cone(300, 875, -450, 0.52, 0.55);
    public static Cone cone2 = new Cone(225, 875, -450, 0.52, 0.55);
    public static Cone cone3 = new Cone(150, 875, -450, 0.52, 0.55);
    public static Cone cone4 = new Cone(75, 875, -450, 0.52, 0.55);
    public static Cone cone5 = new Cone(0, 875, -450, 0.52, 0.55);
    public static int DROP_TICKS = 350;
